...
define('REDIRECT_URL', 'http://localhost/analytics/demo/index.php');
define('CLIENT_ID', '940966921181-pe7dk498p58etrr85hhtn9enki5bs1ui.apps.googleusercontent.com');
define('CLIENT_SECRET', 'INpEmQ1SozCBnHgODN25LShX');
...
if (pg_value('action') == 'revoke') {
  ...
  if ($authHelper->isAuthorized()) {
    ...
    } else if (pg_value('demo') == 'reporting') {
