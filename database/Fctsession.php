<?php
/**
 * Table Definition for fctsession
 */
require_once 'dbRoot.php';

class doFctsession extends dbRoot 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'fctsession';          // table name
    public $ID;                              // int(4)  primary_key not_null
    public $Date;                            // int(4)  unique_key not_null
    public $VisitLength;                     // int(4)  unique_key not_null
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('doFctsession',$k,$v); }

    /* the code above is auto generated do not remove the tag below */
    ###END_AUTOCODE
    
    /*function dimensions(){
    	return "ga:visitlength";
    }*/
}
