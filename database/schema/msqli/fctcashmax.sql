CREATE TABLE `fctcashmax` (
  ...
  PRIMARY KEY (`ID`),
  KEY `fk_fctCashmax_dimDate` (`dimDate`),
  KEY `fk_fctCashmax_dimProfile` (`dimProfile`),
  KEY `fk_fctCashmax_dimVanquisSession` (`dimVanquisSession`),
  KEY `fk_fctCashmax_dimVisitor` (`dimVisitor`),
