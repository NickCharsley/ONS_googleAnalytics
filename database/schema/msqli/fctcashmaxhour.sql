CREATE TABLE `fctcashmaxhour` (
  ...
  PRIMARY KEY (`ID`),
  KEY `fk_fctCashmaxHour_dimDate` (`dimDate`),
  KEY `fk_fctCashmaxHour_dimHour` (`dimHour`),
  KEY `fk_fctCashmaxHour_dimProfile` (`dimProfile`),
  KEY `fk_fctCashmaxHour_dimVanquisSession` (`dimVanquisSession`),
