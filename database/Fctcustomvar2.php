<?php
/**
 * Table Definition for fctcustomvar2
 */
require_once 'dbRoot.php';

class doFctcustomvar2 extends dbRoot 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'fctcustomvar2';       // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('doFctcustomvar2',$k,$v); }
