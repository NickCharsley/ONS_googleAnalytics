<?php
/**
 * Table Definition for fctmobile
 */
require_once 'dbRoot.php';

class doFctmobile extends dbRoot 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'fctmobile';           // table name
    protected $ID;                              // int(4)  primary_key not_null
    protected $dimDate;                         // int(4)  unique_key not_null
    protected $dimProfile;                      // int(4)  unique_key not_null
    protected $dimMobile;                       // int(4)  unique_key not_null
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('doFctmobile',$k,$v); }
