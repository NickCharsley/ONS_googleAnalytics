<?php
/**
 * Table Definition for fctcustomvar
 */
require_once 'dbRoot.php';

class doFctcustomvar extends dbRoot 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'fctcustomvar';        // table name
    public $ID;                              // int(4)  primary_key not_null
    public $dimDate;                         // int(4)  unique_key not_null
    public $dimProfile;                      // int(4)  unique_key not_null
    public $dimCustomVar1;                   // int(4)  unique_key not_null
    public $dimCustomVar2;                   // int(4)  unique_key not_null
    public $dimCustomVar3;                   // int(4)  unique_key not_null
    public $dimCustomVar4;                   // int(4)  unique_key not_null
    public $dimCustomVar5;                   // int(4)  unique_key not_null
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('doFctcustomvar',$k,$v); }
