<?php
/**
 * Table Definition for fctnetwork
 */
require_once 'dbRoot.php';

class doFctnetwork extends dbRoot 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'fctnetwork';          // table name
    protected $ID;                              // int(4)  primary_key not_null
    protected $dimDate;                         // int(4)  unique_key not_null
    protected $dimProfile;                      // int(4)  unique_key not_null
    protected $dimNetwork;                      // int(4)  unique_key not_null
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('doFctnetwork',$k,$v); }
