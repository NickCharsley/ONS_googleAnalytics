<?php
/**
 * Table Definition for fctvscustomvar3
 */
require_once 'dbRoot.php';

class doFctvscustomvar3 extends dbRoot 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'fctvscustomvar3';     // table name
    public $ID;                              // int(4)  primary_key not_null
    public $dimDate;                         // int(4)   not_null
    public $dimProfile;                      // int(4)   not_null
    public $dimCustomVar3;                   // int(4)   not_null
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('doFctvscustomvar3',$k,$v); }
